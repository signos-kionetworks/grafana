 ...
 */
@Service
public class TypeExecutionBO implements IfzSelectBO<TypeExecution>, Serializable {
	...
	public TypeExecution selectById(int id) throws GenericException {
		final Optional<com.kio.applications.validator.model.TypeExecution> result = this.typeExecutionMapper
				.selectOne(c -> c.where(com.kio.applications.validator.dao.TypeExecutionDynamicSqlSupport.id,
	...
	public TypeExecution selectByName(String value) throws GenericException {
		final Optional<com.kio.applications.validator.model.TypeExecution> result = this.typeExecutionMapper
				.selectOne(c -> c
						.where(com.kio.applications.validator.dao.TypeExecutionDynamicSqlSupport.name,
