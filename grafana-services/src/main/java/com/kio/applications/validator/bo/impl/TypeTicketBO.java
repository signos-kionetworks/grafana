...
public class TypeTicketBO implements IfzSelectBO<TypeTicket>, Serializable {
	...
	public TypeTicket selectById(int id) throws GenericException {
		final Optional<com.kio.applications.validator.model.TypeTicket> result = this.typeTicketMapper
				.selectOne(c -> c.where(
						com.kio.applications.validator.dao.TypeTicketDynamicSqlSupport.id,
	...
	public TypeTicket selectByName(String value) throws GenericException {
		final Optional<com.kio.applications.validator.model.TypeTicket> result = this.typeTicketMapper
				.selectOne(c -> c.where(
						com.kio.applications.validator.dao.TypeTicketDynamicSqlSupport.name,
