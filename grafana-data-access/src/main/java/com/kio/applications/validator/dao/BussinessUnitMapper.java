...
import static com.kio.applications.validator.dao.BussinessUnitDynamicSqlSupport.bussinessUnit;
import static com.kio.applications.validator.dao.BussinessUnitDynamicSqlSupport.descr;
import static com.kio.applications.validator.dao.BussinessUnitDynamicSqlSupport.id;
import static com.kio.applications.validator.dao.BussinessUnitDynamicSqlSupport.name;
...
public interface BussinessUnitMapper {
	 ...
	 */
	@SelectProvider(type = SqlProviderAdapter.class, method = "select")
	@Results(id = "BussinessUnitResult", value = {
