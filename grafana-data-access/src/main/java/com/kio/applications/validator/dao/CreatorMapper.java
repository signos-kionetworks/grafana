...
import static com.kio.applications.validator.dao.CreatorDynamicSqlSupport.creator;
import static com.kio.applications.validator.dao.CreatorDynamicSqlSupport.descr;
import static com.kio.applications.validator.dao.CreatorDynamicSqlSupport.id;
import static com.kio.applications.validator.dao.CreatorDynamicSqlSupport.name;
...
public interface CreatorMapper {
	...
	default long count(CountDSLCompleter completer) {
		return MyBatis3Utils.countFrom(this::count, creator, completer);
	}
	 ...
	 * @return the int
	 */
	default int insert(Creator record) {
		return MyBatis3Utils.insert(this::insert, record, creator,
	 ...
	 * @return the int
	 */
	default int insertMultiple(Collection<Creator> records) {
	 ...
	 * @return the int
	 */
	default int insertSelective(Creator record) {
		return MyBatis3Utils.insert(this::insert, record, creator,
	 ...
	 * @return the optional
	 */
	default Optional<Creator> selectByPrimaryKey(Integer id_) {
	...
	default int update(UpdateDSLCompleter completer) {
		return MyBatis3Utils.update(this::update, creator, completer);
	}
	 ...
	 * @return the int
	 */
	default int updateByPrimaryKey(Creator record) {
	 ...
	 * @return the int
	 */
	default int updateByPrimaryKeySelective(Creator record) {
